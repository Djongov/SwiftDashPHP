...
class ThemeSwitcher
{
    ...
    {
        return '<button title="Toggle Light/Dark" type="button" class="theme-toggle h-12 w-10 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2">
