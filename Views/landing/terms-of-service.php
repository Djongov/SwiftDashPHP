...
<div class="container ml-4 p-4">
    ...
    <p>Updated at <?php echo UPDATE_DATE ?></p>
    ...
    <p class="py-6"><strong><?php echo SITE_TITLE ?>
        ...
        <br>
        <br>
        These Terms &amp; Conditions are a contract between you and <span class="font-semibold"><?php echo SITE_TITLE ?>
        </span> (referred to in these Terms &amp; Conditions as "<span class="font-semibold"><?php echo SITE_TITLE ?>
        </span>", "us", "we" or "our"), the provider of the <span class="font-semibold"><?php echo SITE_TITLE ?>
        </span> website and the services accessible from the <span class="font-semibold"><?php echo SITE_TITLE ?>
        </span> website (which are collectively referred to in these Terms &amp; Conditions as the "<span class="font-semibold"><?php echo SITE_TITLE ?>
        </span> Service").
        <br>
        <br>
    ...
    <ul class="ml-6">
        ...
        <li class="list-disc">
            <strong>Company:</strong> when this policy mentions “Company,” “we,” “us,” or “our,” it refers to <strong><?php echo COMPANY_NAME ?></strong>, <strong><?php echo COMPANY_COUNTRY ?>, <?php echo COMPANY_ADDRESS ?></strong> that is responsible for your information under this Privacy Policy.
        </li>
        <li class="list-disc">
            <strong>Country:</strong> where <span class="font-semibold"><?php echo SITE_TITLE ?>
                or the owners/founders of <span class="font-semibold"><?php echo SITE_TITLE ?>
                    are based, in this case is <a><?php echo COMPANY_COUNTRY ?></a>.
        </li>
        <li class="list-disc">
            <strong>Customer:</strong> refers to the company, organization or person that signs up to use the <span class="font-semibold"><?php echo SITE_TITLE ?>
                Service to manage the relationships with your consumers or service users.
        </li>
        <li class="list-disc">
            <strong>Device:</strong> any internet connected device such as a phone, tablet, computer or any other device that can be used to visit <span class="font-semibold"><?php echo SITE_TITLE ?>
        ...
        <li class="list-disc">
            <strong>Personnel:</strong> refers to those individuals who are employed by <span class="font-semibold"><?php echo SITE_TITLE ?>
        ...
        <li class="list-disc">
            <strong>Service:</strong> refers to the service provided by <span class="font-semibold"><?php echo SITE_TITLE ?>
        ...
        <li class="list-disc">
            <strong>Website:</strong> <span class="font-semibold"><?php echo SITE_TITLE ?>
                ’s site, which can be accessed via this URL: <a class="underline text-<?php echo $theme ?>-500 hover:text-<?php echo $theme ?>-700" href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] ?>
"><?php echo 'https://' . $_SERVER['HTTP_HOST'] ?>
                </a>
        </li>
        <li class="list-disc">
            <strong>You:</strong> a person or entity that is registered with <span class="font-semibold"><?php echo SITE_TITLE ?>
                to use the Services.
        </li>
    </ul>
    ...
    <ul class="ml-6">
        <li class="list-disc">Via Email: <a class="underline text-<?php echo $theme ?>-500 hover:text-<?php echo $theme ?>-700" href="mailto:<?php echo COMPANY_EMAIL ?>"><?php echo COMPANY_EMAIL ?></a></li>
        <li class="list-disc">Via Phone Number: <a class="underline text-<?php echo $theme ?>-500 hover:text-<?php echo $theme ?>-700" href="tel:<?php echo COMPANY_PHONE ?>"><?php echo COMPANY_PHONE ?></a></li>
    </ul>
</div>
